      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem 1.5rem' }}>
        <div style={{ width: '100%', maxWidth: 400 }}>
          <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
            <h1 style={{ fontSize: '1.5rem', fontWeight: 700, color: '#1a1a1a', marginBottom: '0.4rem' }}>Recuperar senha</h1>
            <p style={{ color: '#4a5568', fontSize: '0.875rem' }}>Enviaremos um link para redefinir sua senha</p>
          </div>
          ...
          <div style={{ backgroundColor: 'white', border: '1px solid #d4ddc8', borderRadius: 8, padding: '2rem' }}>
            {enviado ? (
              <div style={{ textAlign: 'center' }}>
                ...
                <h2 style={{ fontSize: '1rem', fontWeight: 700, marginBottom: '0.5rem', color: '#1a1a1a' }}>E-mail enviado!</h2>
          ...
          <div style={{ textAlign: 'center', marginTop: '1.25rem' }}>
            <Link href="/auth/login"
              style={{ display: 'inline-flex', alignItems: 'center', gap: 5, color: '#2d6a4f', fontWeight: 600, textDecoration: 'none', fontSize: '0.875rem' }}>
              <ArrowLeft size={14} />
              Voltar para o login
            </Link>
          </div>
